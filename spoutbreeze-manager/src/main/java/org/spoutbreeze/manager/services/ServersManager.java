...
public class ServersManager {
    ...
    private final ServerJdbcRepository serverRepository;

    public ServersManager(ServerJdbcRepository serverRepository) {
        this.serverRepository = serverRepository;
    }

    public Optional<Server> getServer(Long serverId) {
        logger.info("Looking for server with id {}", serverId);
