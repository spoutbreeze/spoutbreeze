...
public class EndpointsManager {
    ...
    private final EndpointJdbcRepository endpointRepository;

    public EndpointsManager(EndpointJdbcRepository endpointRepository) {
        this.endpointRepository = endpointRepository;
    }

    public Optional<Endpoint> getEndpoint(Long endpointId) {
        logger.info("Looking for endpoint with id {}", endpointId);
