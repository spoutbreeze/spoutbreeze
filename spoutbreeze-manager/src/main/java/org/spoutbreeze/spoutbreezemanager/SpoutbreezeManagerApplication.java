...
import org.spoutbreeze.spoutbreezemanager.services.BroadcastingAssigner;
...
public class SpoutbreezeManagerApplication {
    ...
    @Autowired
    @Qualifier("broadcastingAssigner")
    private static BroadcastingAssigner broadcastingAssigner;
