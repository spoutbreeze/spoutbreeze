...
/**
Class Pagination origin https://github.com/ikkez/f3-pagination/tree/master/lib
...
class Pagination
{
    ...
    private $template = 'tables/pagebrowser.phtml';
    private $routeKey;
     ...
     * @param string $key
     */
    public function setRouteKey($key): void
    {
        $this->routeKey = $key;
    }
     ...
     * @param string $prefix
     */
    public function setRouteKeyPrefix($prefix): void
    {
     ...
     * @param $linkPath
     */
    public function setLinkPath($linkPath): void
    {
        $this->linkPath = (mb_substr($linkPath, 0, 1) != '/') ? '/'.$linkPath : $linkPath;
        if (mb_substr($this->linkPath, -1) != '/') {
            $this->linkPath .= '/';
        }
    }
