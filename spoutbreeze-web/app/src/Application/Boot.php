...
abstract class Boot
{
    ...
    {
        $configuredEnvironment = getenv('SPB_ENV');
        if (in_array($configuredEnvironment, [Environment::DEVELOPMENT, Environment::PRODUCTION, Environment::TEST], true)) {
            $this->f3->set('application.environment', $configuredEnvironment);
