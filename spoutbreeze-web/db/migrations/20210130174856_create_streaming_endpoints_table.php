...
final class CreateStreamingEndpointsTable extends AbstractMigration
{
    public function up(): void
    {
        $table = $this->table('streaming_endpoints');
        $table->addColumn('name', 'string', ['limit' => 256, 'null' => false])
              ->addColumn('url', 'string', ['limit' => 256, 'null' => false])
    ...
    {
        $this->table('streaming_endpoints')->drop()->save();
    }
}
